...
<p>The web/application server is leaking version information via the &quot;Server&quot; HTTP response header. Access to such information may facilitate attackers identifying other vulnerabilities your web/application server is subject to.</p>
	...
	<tr>
		...
		<td><details open="open">
				...
				<pre><code>GET http://localhost:5000/static/login.css HTTP/1.1
host: localhost:5000
user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:125.0) Gecko/20100101 Firefox/125.0
pragma: no-cache
cache-control: no-cache
...
Connection: close
  ...
  {
    &quot;id&quot;: 2,
    &quot;response&quot;: &quot;No, I do have guidelines. The task is to analyze a JSON data set from a disk image, and I&#39;m ready to answer questions about it based on that structure and the provided information. What&#39;s your first question?&quot;,
...
<p>Remove all comments that return information that may help an attacker and fix any underlying problems they refer to.</p>
								...
								<li>
									<h5>
										<a
											href="#alert-type-11">Modern Web Application</a> <span>(1)</span>
									</h5>
									<ol>
										<li><details>
												<summary>
...
&lt;p&gt;You should be redirected automatically to the target URL: &lt;a href=&quot;/login&quot;&gt;/login&lt;/a&gt;. If not, click the link.
	...
	<tr>
		<th scope="row">Evidence</th>
		<td><pre><code>eyJfZmxhc2hlcyI6W3siIHQiOlsiZXJyb3IiLCJXcm9uZyBwYXNzd29yZCBvciBVc2VybmFtZSJdfV19.Z174-w.9WZpvjJPL3XfHQysizxqkc2lrws</code></pre></td>
	</tr>
	<tr>
		<th scope="row">Solution</th>
		<td> 
<p>This is an informational alert rather than a vulnerability and so there is nothing to fix.</p>
								...
								<li>
									...
									<ol>
										<li><details>
												<summary>
													<span class="request-method-n-url">GET http://localhost:5000</span>
												</summary>
...
<p>Check for differences in response based on fuzzed User Agent (eg. mobile sites, access as a Search Engine Crawler). Compares the response statuscode and the hashcode of the response body with the original response.</p>
	...
	<tr>
		<th scope="row">Request</th>
		<td><details open="open">
				<summary>Request line and header section (167 bytes)</summary>
				
				<pre><code>GET http://localhost:5000 HTTP/1.1
host: localhost:5000
...
cache-control: no-cache
	...
	<tr>
		...
		<td><details open="open">
				...
				<pre><code>HTTP/1.1 200 OK
Server: Werkzeug/3.0.4 Python/3.12.8
Date: Sun, 15 Dec 2024 15:44:52 GMT
Content-Type: text/html; charset=utf-8
Content-Length: 906
Connection: close
						...
						<li class="alerts--site-li">
							...
							<ol>
								...
								<li>
									<h5>
										<a
											href="#alert-type-10">Loosely Scoped Cookie</a> <span>(1)</span>
									</h5>
									<ol>
										<li><details>
												<summary>
...
<table class="alerts-table">
	<tr>
		...
		<td>
			<ul class="alert-tags-list">
				<li>
					<span><a href="https://cwe.mitre.org/data/definitions/565.html">CWE-565</a></span> 
				</li>
				<li>
					<span><a href="https://owasp.org/www-project-web-security-testing-guide/v42/4-Web_Application_Security_Testing/06-Session_Management_Testing/02-Testing_for_Cookies_Attributes">WSTG-v42-SESS-02</a></span> 
				</li>
...
<p>Cookies can be scoped by domain or path. This check is only concerned with domain scope.The domain scope applied to a cookie determines which domains can access it. For example, a cookie can be scoped strictly to a subdomain e.g. www.nottrusted.com, or loosely scoped to a parent domain e.g. nottrusted.com. In the latter case, any subdomain of nottrusted.com can access the cookie. Loosely scoped cookies are common in mega-applications like google.com and live.com. Cookies set from a subdomain like app.foo.bar are transmitted only to that domain by the browser. However, cookies scoped to a parent-level domain may be transmitted to the parent, or any subdomain of the parent.</p>
	...
	<tr>
		<th scope="row">Other info</th>
		<td> 
<p>The origin domain used for comparison was:</p>

<p>localhost</p>

<p>session=eyJfZmxhc2hlcyI6W3siIHQiOlsiZXJyb3IiLCJXcm9uZyBwYXNzd29yZCBvciBVc2VybmFtZSJdfV19.Z174-w.9WZpvjJPL3XfHQysizxqkc2lrws</p>
 </td>
	</tr>
	<tr>
		<th scope="row">Request</th>
		...
		<section id="appendix" class="appendix">
			...
			<section id="alert-types" class="alert-types">
				...
				<ol>
					<li
						id="alert-type-0">
						<h4>SQL Injection - Oracle - Time Based</h4>
						<table class="alert-types-table">
							<tr>
								...
								<td>
									 ...
									 (<span>plugin ID</span>: <a
										href="https://www.zaproxy.org/docs/alerts/40021/">40021</a>)        
								</td>
							</tr>
							<tr>
						...
						<table class="alert-types-table">
							<tr>
								...
								<td>
									   ...
									   <span>raised by a passive scanner</span> <span>(<a
										href="https://www.zaproxy.org/docs/alerts/90033/">Loosely Scoped Cookie</a>)
									</span>   
								</td>
							</tr>
							<tr>
								<th scope="row">CWE ID</th>
								<td><a
									href="https://cwe.mitre.org/data/definitions/565.html">565</a></td>
							</tr>
							<tr>
								<th scope="row">WASC ID</th>
								<td>15</td>
							...
							<tr>
								...
								<td>
									<ol>
										<li><a
											href="https://tools.ietf.org/html/rfc6265#section-4.1">https://tools.ietf.org/html/rfc6265#section-4.1</a></li>
										<li><a
											href="https://owasp.org/www-project-web-security-testing-guide/v41/4-Web_Application_Security_Testing/06-Session_Management_Testing/02-Testing_for_Cookies_Attributes.html">https://owasp.org/www-project-web-security-testing-guide/v41/4-Web_Application_Security_Testing/06-Session_Management_Testing/02-Testing_for_Cookies_Attributes.html</a></li>
										<li><a
											href="https://code.google.com/p/browsersec/wiki/Part2#Same-origin_policy_for_cookies">https://code.google.com/p/browsersec/wiki/Part2#Same-origin_policy_for_cookies</a></li>
									</ol>
								</td>
							</tr>
						</table>
						...
						<table class="alert-types-table">
							<tr>
								...
								<td>
									     ...
									     <span>raised by an active scanner</span>
									 (<span>plugin ID</span>: <a
										href="https://www.zaproxy.org/docs/alerts/10104/">10104</a>)        
								</td>
							</tr>
					...
					<li
						id="alert-type-14">
						<h4>Verification Request Identified</h4>
						<table class="alert-types-table">
							<tr>
								<th scope="row">Source</th>
								<td>
									   ...
									   <span>raised by a passive scanner</span> <span>(<a
										href="https://www.zaproxy.org/docs/alerts/10113/">Verification Request Identified</a>)
									</span>   
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<ol>
										<li><a
											href="https://www.zaproxy.org/docs/desktop/addons/authentication-helper/verif-id">https://www.zaproxy.org/docs/desktop/addons/authentication-helper/verif-id</a></li>
									</ol>
								</td>
							</tr>
						</table>
